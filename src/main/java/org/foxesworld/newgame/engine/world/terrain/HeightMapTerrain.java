...
import org.foxesworld.newgame.NewGameInterface;
...
public class HeightMapTerrain implements HeightMapTerrainInterface {
    ...
    private NewGameInterface app;

    public HeightMapTerrain(AssetManager assetManager, BulletAppState bulletAppState, NewGameInterface app) {
